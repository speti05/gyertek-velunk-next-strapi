        ...
        <div className="auth-page__signup-details-content">
          ...
          <div className="auth-page__signup-details-section">
            ...
            <DetailRow
              ...
              value={signup.documentExpiryDate ? formatDate(signup.documentExpiryDate, locale) : null}
            />
              ...
              {signup.companions.map((companion, idx) => (
                <div key={idx} className="auth-page__signup-companion">
                  ...
                  <DetailRow
                    label={SIGNUP_TRAVEL_DOCUMENT_ISSUE_DATE}
                    value={
                      companion.documentIssueDate ? formatDate(companion.documentIssueDate, locale) : null
                    }
                  />
                  <DetailRow
                    label={SIGNUP_TRAVEL_DOCUMENT_EXPIRY_DATE}
                    value={
                      companion.documentExpiryDate ? formatDate(companion.documentExpiryDate, locale) : null
                    }
                  />

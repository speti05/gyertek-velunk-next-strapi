...
function SubmitBtn() {
  const { LOADING_LABEL, AUTH_LOGIN_LABEL } = useTexts();
    ...
    <>
      ...
      <form ref={formRef} className="auth-page__form" onSubmit={handleSubmit}>
        ...
        <p className="auth-page__hint hint">
          ...
          <CustomLink href={localizePath(Route.Register)} color="primary">
            {AUTH_REGISTER_LABEL}
          </CustomLink>
        </p>
        <p className="auth-page__forgot-link hint">
          <CustomLink href={localizePath(Route.ForgotPassword)} color="secondary">
